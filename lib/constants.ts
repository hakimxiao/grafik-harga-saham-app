...
export const ALERT_TYPE_OPTIONS = [
    { value: 'upper', label: 'Batas Atas' },
    { value: 'lower', label: 'Batas Bawah' },
];
...
// Konfigurasi Grafik TradingView
export const MARKET_OVERVIEW_WIDGET_CONFIG = {
    colorTheme: 'dark',
    dateRange: '12M',
    locale: 'id', // ubah ke bahasa Indonesia
    largeChartUrl: '',
    isTransparent: true,
...
export const CANDLE_CHART_WIDGET_CONFIG = (symbol: string) => ({
    ...
    symbol: symbol.toUpperCase(),
    theme: 'dark',
    timezone: 'Asia/Jakarta', // ubah timezone ke Jakarta
    backgroundColor: '#141414',
    gridColor: '#141414',
    watchlist: [],
...
export const NO_MARKET_NEWS =
    '<p class="mobile-text" style="margin:0 0 20px 0;font-size:16px;line-height:1.6;color:#4b5563;">Tidak ada berita pasar hari ini. Silakan periksa kembali besok.</p>';
