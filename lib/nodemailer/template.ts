                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <ul class="mobile-text dark-text-secondary" style="margin: 0 0 30px 0; padding-left: 20px; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                <li style="margin-bottom: 12px;">Atur daftar pantauan Anda untuk mengikuti saham favorit Anda</li>
                                <li style="margin-bottom: 12px;">Buat peringatan harga dan volume sehingga Anda tidak melewatkan pergerakan apa pun</li>
                                <li style="margin-bottom: 12px;">Jelajahi dasbor untuk mengetahui tren dan berita pasar terkini</li>
                            </ul>
                            
                            <!-- Additional Text -->
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 40px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                Kami akan terus memberi Anda informasi terbaru, wawasan, dan peringatan tepat waktu — sehingga Anda dapat fokus dalam melakukan panggilan yang tepat.
                            </p>
...
<head>
    ...
    <meta name="format-detection" content="telephone=no">
    <meta name="x-apple-disable-message-reformatting">
    <title>Ringkasan Berita Pasar Hari Ini</title>
    <!--[if mso]>
    <noscript>
        <xml>
            <o:OfficeDocumentSettings>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <h1 class="mobile-title dark-text" style="margin: 0 0 20px 0; font-size: 24px; font-weight: 600; color: #FDD458; line-height: 1.2;">
                                Ringkasan Berita Pasar Hari Ini
                            </h1>
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    Anda menerima ini karena Anda berlangganan pembaruan berita Signalist.
                                </p>
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
...
<head>
    ...
    <meta name="format-detection" content="telephone=no">
    <meta name="x-apple-disable-message-reformatting">
    <title>Peringatan Harga: {{symbol}} Mencapai Target Atas</title>
    <!--[if mso]>
    <noscript>
        <xml>
            <o:OfficeDocumentSettings>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <div class="dark-info-box" style="background-color: #212328; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text dark-text-secondary" style="margin: 0 0 10px 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>Trigger:</strong> Harga melebihi ambang batas atas Anda {{targetPrice}}
                                </p>
                            </div>
                            ...
                            <div style="background-color: #050505; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text" style="margin: 0; font-size: 14px; line-height: 1.5; color: #ccdadc;">
                                    {{symbol}} telah mencapai harga target Anda! Ini bisa menjadi saat yang tepat untuk meninjau posisi Anda dan mempertimbangkan untuk mengambil keuntungan atau menyesuaikan strategi Anda.
                                </p>
                            </div>
...
<head>
    ...
    <meta name="format-detection" content="telephone=no">
    <meta name="x-apple-disable-message-reformatting">
    <title>Peringatan Harga: {{symbol}} Mencapai Target Lebih Rendah</title>
    <!--[if mso]>
    <noscript>
        <xml>
            <o:OfficeDocumentSettings>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <div class="dark-info-box" style="background-color: #212328; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text dark-text-secondary" style="margin: 0 0 10px 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>Trigger:</strong> Harga turun di bawah ambang batas bawah Anda {{targetPrice}}
                                </p>
                            </div>
                            ...
                            <div style="background-color: #050505; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text" style="margin: 0; font-size: 14px; line-height: 1.5; color: #ccdadc;">
                                    {{symbol}} turun di bawah harga target Anda. Ini mungkin saat yang tepat untuk membeli.
                                </p>
                            </div>
...
<head>
    ...
    <meta name="format-detection" content="telephone=no">
    <meta name="x-apple-disable-message-reformatting">
    <title>Peringatan Volume: {{symbol}}</title>
    <!--[if mso]>
    <noscript>
        <xml>
            <o:OfficeDocumentSettings>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 0 40px 40px 40px;">
                            ...
                            <div class="dark-info-box" style="background-color: #1f2937; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                <h3 class="dark-text" style="margin: 0 0 15px 0; font-size: 18px; font-weight: 600; color: #ffffff;">
                                    Detail Lonjakan Volume
                                </h3>
                                <p class="mobile-text dark-text-secondary" style="margin: 0 0 10px 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>Trigger:</strong> {{alertMessage}}
                                </p>
                                <p class="mobile-text dark-text-secondary" style="margin: 0 0 10px 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>Volume Rata-Rata:</strong> {{averageVolume}}M shares
                                </p>
                                <p class="mobile-text dark-text-secondary" style="margin: 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    <strong>Lonjakan Terdeteksi:</strong> {{volumeSpike}} di atas aktivitas perdagangan normal
                                </p>
                            </div>
                            ...
                            <div class="dark-info-box" style="background-color: #1f2937; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text dark-text-secondary" style="margin: 0; font-size: 16px; line-height: 1.5; color: #9ca3af;">
                                    Volume yang tinggi sering kali menunjukkan peningkatan minat investor, potensi peristiwa berita, atau pergerakan harga yang signifikan. This could signal an opportunity to investigate what's driving the activity.
                                </p>
                            </div>
                            ...
                            <div class="dark-info-box" style="background-color: #1f2937; border-radius: 6px; padding: 15px; margin-bottom: 20px; border: 1px solid #374151;">
                                <p class="dark-text-muted" style="margin: 0; font-size: 13px; line-height: 1.4; color: #6b7280; text-align: center;">
                                    <strong>Disclaimer:</strong> Peringatan ini hanya untuk tujuan informasi dan tidak boleh dianggap sebagai nasihat investasi. Volume tinggi tidak menjamin arah harga. Selalu lakukan riset Anda sendiri sebelum membuat keputusan investasi.
                                </p>
                            </div>
...
<head>
    ...
    <meta name="format-detection" content="telephone=no">
    <meta name="x-apple-disable-message-reformatting">
    <title>Kami Merindukanmu! Wawasan Pasar Anda Menunggu</title>
    <!--[if mso]>
    <noscript>
        <xml>
            <o:OfficeDocumentSettings>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                Kami perhatikan Anda sudah lama tidak mengunjungi Signalist. Pasar telah bergerak, dan mungkin ada beberapa peluang yang tidak ingin Anda lewatkan!
                            </p>
                            ...
                            <div class="dark-info-box" style="background-color: #050505; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                                ...
                                <p class="mobile-text" style="margin: 0; font-size: 14px; line-height: 1.5; color: #ccdadc;">
                                    Pasar telah aktif akhir-akhir ini! Indeks-indeks utama telah mengalami pergerakan yang signifikan, dan mungkin ada peluang pada saham-saham yang Anda pantau yang tidak ingin Anda lewatkan.
                                </p>
                            </div>
                            
                            <!-- Encouragement Message -->
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 40px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                Daftar pantauan Anda masih aktif dan siap membantu Anda terus memantau investasi Anda. Jangan biarkan peluang pasar berlalu begitu saja!
                            </p>
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    Pertanyaan? Balas email ini atau hubungi tim dukungan kami.
                                </p>
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
