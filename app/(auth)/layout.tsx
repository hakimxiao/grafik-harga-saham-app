            ...
            <section className="auth-right-section">
                <div className="z-10 relative lg:mt-4 lg:mb-16">
                    <blockquote className="auth-blockquote">
                        Signalist mengubah daftar pantauan saya menjadi daftar pemenang. Peringatannya tepat sasaran, dan saya merasa lebih percaya diri dalam mengambil langkah di pasar.
                    </blockquote>
                    <div className="flex items-center justify-between">
                        <div>
                            <cite className="auth-testimonial-author">- M. Havis Wijaya</cite>
